            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3 py-2 hover:opacity-80 transition-opacity">
                  <User className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="text-base font-semibold text-foreground">Elizia Maria Pereira Costa</h3>
                    <p className="text-sm text-muted-foreground">Tecnologia em Análise e Desenvolvimento de Sistemas</p>
                    <p className="text-xs text-muted-foreground">GitHub: eliziacosta</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3 py-2 hover:opacity-80 transition-opacity">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">GitHub: afraniocaires</p>
                ...
                <div className="flex items-start gap-3 py-2 hover:opacity-80 transition-opacity">
                  <User className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="text-base font-semibold text-foreground">Isaque Rodrigues</h3>
                    <p className="text-xs text-muted-foreground">Análise e Desenvolvimento de Sistemas</p>
                    <p className="text-xs text-muted-foreground">GitHub: IsaqueTADS</p>
                  </div>
                </div>
